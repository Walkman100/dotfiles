...
alias youtube-dl='python3 `which youtube-dl` --external-downloader aria2c --external-downloader-args "-s 999 -j 5 -x 16 -k 1M --console-log-level error" -i'
alias yt-dlp='python3 `which yt-dlp` --downloader aria2c --downloader-args aria2c:"-s 999 -j 5 -x 16 -k 1M --console-log-level error" -i'
